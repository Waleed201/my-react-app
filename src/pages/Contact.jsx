        ...
        <div className='section-two'>
          <div className='social-media'>
            ...
            <div className='social-icons'>
              ...
              <a href="https://x.com/KFUPMYearBook" target="_blank" rel="noopener noreferrer" className="fa-brands fa-twitter">
                <img src={xIcon} alt="" />
                <h3>@KFUPMYearBook</h3>
              </a>
              <a href="https://www.linkedin.com/company/kfupm-yearbook/" target="_blank" rel="noopener noreferrer" className="fa-brands fa-linkedin">
